...
$valorentrada = $_REQUEST['valorentrada'];
    ...
    $sql="SELECT * FROM Acesso WHERE Nome='$user1' and Senha='$pass1'";
    	...
    	if ($result=$conn->query($sql)){
    		...
    		// Mysqli_num_row checks if username1 and password1 exist.
...
$horas = date("h:i:sa");
				...
				$sql ="UPDATE ControleCaixa SET Entrada1='$user1', Entrada2='$user2', ValorEntrada='$valorentrada', timeEntrada='$horas', StatusEntrada = '1' WHERE Data = '$data'";
